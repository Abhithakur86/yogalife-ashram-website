  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div
          className="absolute bottom-10 left-36 flex flex-col items-start text-[#feefe1]"
          style={{ fontFamily: "Philosopher, serif" }}
        >
          <h2 className="font-semibold text-[28px] mb-2">(Sao Paulo)</h2>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="relative mb-14 flex justify-center">
            <img
              src="/gls.png"
              alt=""
              className="absolute left-60 top-full mt-3 max-w-2xl"
            />
          ...
          <div className="mt-16 flex flex-col items-center">
            ...
            >
              ...
              <ChevronUp
                ...
                className={`transition-transform duration-300 ${
                  openLegacy ? "rotate-180" : "rotate-45"
                }`}
              />
            </button>
            ...
            {openLegacy && (
              <div className="mt-40 grid grid-cols-1 md:grid-cols-2 gap-36 relative">
                <img
                  src="/ladki.png"
                  alt=""
...
>
  Know More
                ...
                <div className="relative mt-32 rounded-xl overflow-hidden w-[125%] -ml-24">
  <img
...
/>
                 ...
                 <div className="absolute top-[350px] right-56 flex gap-2">
  {slides.map((_, index) => (
    <button
      key={index}
  ...
  Read More
        ...
        <div className="flex justify-end">
          <img
            src="/baba.png"
            alt=""
            className="w-[420px] rounded-xl object-cover"
          />
        </div>
      </div>
    )}
...
<div className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
  ...
  <img
    src="/bg.png"
    alt=""
    className="absolute left-36 mt-9    -translate-y-1/2 w-[450px] opacity-65 pointer-events-none z-0"
  />
...
{openTeachers && (
  <div className="mt-32 max-w-6xl mx-auto px-6">
    ...
    <div className="text-center">
      <h3
        className="text-[23px] -translate-x-16 "
        style={{ fontFamily: "Martel Sans, sans-serif" }}
      >
        The Guider
      </h3>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 max-w-6xl w-full">
    <div className="bg-[#b40800] w-[450px] rounded-2xl flex justify-center items-end p-6">
      <img
        src="/admi.png"
        alt=""
    ...
    <div className="bg-gradient-to-r from-red-200  to-[#ffffff]  -translate-x-[85px] pl-14  mx-auto  py-6">
